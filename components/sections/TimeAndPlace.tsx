...
const TimeAndPlace = () => {
  ...
  return (
    <section id="time-place" className="font-playfair">
      <AuroraBackground className="px-6 py-20 bg-[#1d1035c2]">
        <div className="max-w-6xl mx-auto text-center ">
          <FadeUp>
            <SectionHeading>Time & Place</SectionHeading>
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 mt-12 mb-7">
              {/* Time Column */}
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/20 hover:border-amber-500/40 transition-all flex flex-col">
                ...
                <div className="space-y-3 text-amber-100 grow">
                  ...
                  <p className="text-2xl mt-4 text-amber-100">
                    5:00 PM onwards
                  </p>
                </div>
